...
public class PrintCalendar
{
	public static void main(String[] args)
	{
		...
		{
			String yearString=JOptionPane.showInputDialog("enter full year:");
			...
			option=JOptionPane.showConfirmDialog(null,"print another month?");
		}
	}
	...
	{
		String output="    "+getMonthName(month)+" "
