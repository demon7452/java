...
private String[] strsize={"20x15","30x20","40x30"};  //棋盘大小参数，菜单选项
private String[] strmode={"人机对弈","人人对弈"};    //对弈方式的设定
public static boolean iscomputer = true, checkcomputer = true; //设置默认值
private int width,height;    //高度和宽度的参数
private ChessModel cm;      //棋盘
private MainPanel mp;       //面板
...
public ChessFrame() {
	...
	con.add(mp,"Center");
	this.setResizable(false);  //设置大小是否可修改
	this.addWindowListener(new ChessWindowEvent());
	MapSize(20,15);     //设置默认棋盘大小
	//设置菜单栏
	JMenuBar mbar = new JMenuBar();
	this.setJMenuBar(mbar);
	JMenu gameMenu = new JMenu("游戏"); //游戏菜单项设置
	mbar.add(makeMenu(gameMenu, new Object[] {
	   "开局", "棋盘","模式", null, "退出"
	 }, this));
	 
	JMenu lookMenu = new JMenu("视图"); //视图菜单项设置
	mbar.add(makeMenu(lookMenu,new Object[] {
	 "Metal","Motif","Windows"
	 },this));
	 
	JMenu helpMenu = new JMenu("帮助"); //帮助菜单项设置
